...
if __name__ == '__main__':
    ...
    H, L, R = twut.H_two_particles (H1, L1, R1, H1, L1, R1)

    #Ineraction:
    Hx, Lx, Rx = lin.make_x_mpo (N, shift=shift, rescale=dx)
   
    Hx, Lx, Rx = twut.H_two_particles (Hx, Lx, Rx, Hx, -1*Lx, Rx)
    Hx2, Lx2, Rx2 = npmps.prod_2MPO (Hx, Lx, Rx, Hx, Lx, Rx)
    #set up the k for coupling constant
    H, L, R = npmps.sum_2MPO (H, L, R, Hx2, 0.5*Lx2, Rx2)
    ...
    maxdims = [2]*10 + [4]*50 + [8]*300 + [16]*100 + [32]*40
    cutoff = 1e-12
